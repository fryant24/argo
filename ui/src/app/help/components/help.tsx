                ...
                <div className='help-box'>
                    ...
                    <div className='row text-left help-box__download'>
                        <div className='columns small-4'>
                            <a href={`https://git.code.oa.com/henrylwang/argo/releases/download/${SYSTEM_INFO.version}/argo-linux-amd64`}>
                                <i className='fab fa-linux' aria-hidden='true' /> Linux
                            </a>
                        </div>
                        <div className='columns small-4'>
                            <a href={`https://git.code.oa.com/henrylwang/argo/releases/download/${SYSTEM_INFO.version}/argo-darwin-amd64`}>
                                <i className='fab fa-apple' aria-hidden='true' /> macOS
                            </a>
                            <br />
                        </div>
                        <div className='columns small-4'>
                            <a href={`https://git.code.oa.com/henrylwang/argo/releases/download/${SYSTEM_INFO.version}/argo-windows-amd64`}>

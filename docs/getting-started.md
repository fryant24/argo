...
```sh
# Download the binary
curl -sLO https://git.code.oa.com/henrylwang/argo/releases/download/v2.4.3/argo-darwin-amd64
...
```sh
# Download the binary
curl -sLO https://git.code.oa.com/henrylwang/argo/releases/download/v2.4.3/argo-linux-amd64
...
You can download the latest and previous Argo binaries from our [releases page](https://git.code.oa.com/henrylwang/argo/releases/).

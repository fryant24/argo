...
For a complete description of the Argo workflow spec, please refer to [our spec definitions](https://git.code.oa.com/henrylwang/argo/blob/master/pkg/apis/workflow/v1alpha1/workflow_types.go).
  ...
  - name: hardwired-artifact
    inputs:
      ...
      - name: argo-source
        path: /src
        git:
          repo: https://git.code.oa.com/henrylwang/argo.git
          revision: "master"
...
A good example of a CI workflow spec is provided at https://git.code.oa.com/henrylwang/argo/tree/master/examples/influxdb-ci.yaml. Because it just uses the concepts that we've already covered and is somewhat long, we don't go into details here.

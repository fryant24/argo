...
override LDFLAGS += \
  -X git.code.oa.com/henrylwang/argo.version=$(VERSION) \
  -X git.code.oa.com/henrylwang/argo.buildDate=${BUILD_DATE} \
  -X git.code.oa.com/henrylwang/argo.gitCommit=${GIT_COMMIT} \
  -X git.code.oa.com/henrylwang/argo.gitTreeState=${GIT_TREE_STATE}
...
ifneq ($(GIT_TAG),)
override LDFLAGS += -X git.code.oa.com/henrylwang/argo.gitTag=${GIT_TAG}
endif
